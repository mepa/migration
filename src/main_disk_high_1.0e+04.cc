...
const double M_max = 1.0e+04 * M_sun;
...
ofstream center_yes_out("data/script/center_yes_disk_1.0e+04_high_z.out");
ofstream center_no_out("data/script/center_no_disk_1.0e+04_high_z.out");
  for(size_t i = 0; i < clusters.size(); i ++)
    {
